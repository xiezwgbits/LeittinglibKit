#
#  Be sure to run `pod spec lint LTLibKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "xiezw" => "xzwdan@163.com" }
  # Or just: spec.author    = "xiezw"
  # spec.authors            = { "xiezw" => "xiezw@g-bits.com" }
  # spec.social_media_url   = "https://twitter.com/xiezw"
  ...
  spec.subspec 'USE_FB' do |use_fb|
    use_fb.source_files = 'LeitinglibKit/USE_FB/*'
    use_fb.resources = 'LeitinglibKit/USE_FB/leitingbundle.bundle'
    use_fb.vendored_frameworks = 'LeitinglibKit/USE_FB/leitinglib.framework'

  end

  spec.subspec 'USE_FB_TT' do |use_fb_tt|
    use_fb_tt.source_files = 'LeitinglibKit/USE_FB_TT/*'
    use_fb_tt.resources = 'LeitinglibKit/USE_FB_TT/leitingbundle.bundle'
    use_fb_tt.vendored_frameworks = 'LeitinglibKit/USE_FB_TT/leitinglib.framework'
  end
